...
import ru.sma.vaadin.views.helloworld.HelloWorldView;
import ru.sma.vaadin.views.about.AboutView;
 ...
 */
@PWA(name = "VaadinSMA", shortName = "VaadinSMA", enableInstallPrompt = false)
@Theme(themeFolder = "vaadinsma")
@PageTitle("Main")
public class MainLayout extends AppLayout {
    ...
    private Component createDrawerContent(Tabs menu) {
        ...
        logoLayout.add(new Image("images/logo.png", "VaadinSMA logo"));
        logoLayout.add(new H1("VaadinSMA"));
